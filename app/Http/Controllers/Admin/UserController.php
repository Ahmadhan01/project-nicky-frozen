...
class UserController extends Controller
{
    ...
    {
        if ($user->role === 'owner') {
            return back()->withErrors(['error' => 'Akun owner tidak bisa dihapus.']);
        }
        ...
        AuditLog::record('user', ucfirst($role) . " dihapus: {$name} (@{$user->username})");

        return back()->with('success', ucfirst($role) . ' berhasil dihapus!');
    }
}
