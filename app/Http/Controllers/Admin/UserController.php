...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'default_kios_id'  => 'required|exists:kios,id',
        ...
        AuditLog::record('user', "Kasir baru ditambahkan: {$user->name} (@{$user->username})", ['user_id' => $user->id]);
    ...
    public function update(Request $request, User $user)
    {
        ...
        $data = $request->only(['name', 'username', 'default_kios_id', 'default_shift_id', 'avatar_color', 'notes']);
        ...
        AuditLog::record('user', "Data kasir diperbarui: {$user->name} (@{$user->username})", ['user_id' => $user->id]);
